...
public class CatalogUtilTest {
  ...
  public void testCustomCatalogWithoutImpl(String impl) {
    Assertions.assertThatThrownBy(
            () ->
                CatalogUtil.buildCatalog(
                    Collections.emptyMap(),
                    CatalogUtil.CatalogType.CUSTOM,
                    impl,
                    Collections.emptyMap()))
  ...
  public void testInvalidArgs() {
    Assertions.assertThatThrownBy(() -> CatalogUtil.buildCatalog(null, null, null, null))
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessageContaining("catalog properties is null");

    Assertions.assertThatThrownBy(
            () -> CatalogUtil.buildCatalog(Collections.emptyMap(), null, null, null))
        .isInstanceOf(IllegalArgumentException.class)
    ...
    Assertions.assertThatThrownBy(
            () ->
                CatalogUtil.buildCatalog(
                    Collections.emptyMap(), CatalogUtil.CatalogType.CUSTOM, "abc", null))
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessageContaining(
  ...
  public void testBuildHadoopCatalog() {
    ...
    Catalog catalog =
        CatalogUtil.buildCatalog(properties, CatalogUtil.CatalogType.HADOOP, null, conf);

    Assertions.assertThat(catalog).isInstanceOf(HadoopCatalog.class);
    Assertions.assertThat(catalog.name()).isEqualTo("HADOOP");
  ...
  public void testBuildNessieCatalog() {
    ...
    Catalog catalog =
        CatalogUtil.buildCatalog(properties, CatalogUtil.CatalogType.NESSIE, null, null);

    Assertions.assertThat(catalog).isInstanceOf(NessieCatalog.class);
    Assertions.assertThat(catalog.name()).isEqualTo("NESSIE");
  }
  ...
  public void testBuildHiveCatalog() {
    ...
    Catalog catalog =
        CatalogUtil.buildCatalog(properties, CatalogUtil.CatalogType.HIVE, null, null);

    Assertions.assertThat(catalog).isInstanceOf(HiveCatalog.class);
    Assertions.assertThat(catalog.name()).isEqualTo("HIVE");
  }
}
