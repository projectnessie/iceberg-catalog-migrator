...
import static org.projectnessie.tools.catalog.migration.CatalogMigrator.FAILED_TO_DELETE_AT_SOURCE_FILE;
...
public abstract class CatalogMigrationResult {
  ...
  abstract List<TableIdentifier> registeredTableIdentifiers();

  abstract List<TableIdentifier> failedToRegisterTableIdentifiers();

  abstract List<TableIdentifier> failedToDeleteTableIdentifiers();
